...
use Zacksmash\MlbStats\Params\HasScheduleEventTypes;
...
use Zacksmash\MlbStats\Params\HasUsingPrivateEndpoint;
use Zacksmash\MlbStats\Params\HasVenueIds;

class ScheduleType extends MlbStatsRequest
{
    ...
    use HasUsingPrivateEndpoint;
    use HasVenueIds;

    public function __construct(string $scheduleType)
    {
        $this->endpoint = "schedule/$scheduleType";
    }
}
